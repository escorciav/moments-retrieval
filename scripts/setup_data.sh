...
for i in data/interim/mcn/corpus_val_rgb.hdf5 data/interim/mcn/corpus_val_flow.hdf5 data/interim/mcn/rgb-weights.hdf5 data/interim/mcn/flow-weights.hdf5; do
